...
@section('main')
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-good-causes">
                        ...
                        <h3>Surprised Box</h3>
                        <p>Lorem ipsum dolor amet, consectetur amet adipiscing elit, sed do eiusmod  incididunt labore  dolore consectetur amet adipiscing.</p>
    ...
    <section class="active-campaing-area two  pt-0">
        <div class="container">
            <div class="section-title">
            ...
            <div class="campaing-wrap owl-carousel owl-theme">
                ...
                <div class="single-campaing">
                    <div class="campaing-img">
                        <img src="assets/img/campaing/2.jpg" alt="">
                    </div>
                    <div class="campaing-text">
                        <div class="progress pink">
                            <div class="progress-bar">
                ...
                <div class="single-campaing">
                    <div class="campaing-img">
                        <img src="assets/img/campaing/3.jpg" alt="">
                    </div>
                    <div class="campaing-text">
                        <div class="progress pink">
                            <div class="progress-bar">
                ...
                <div class="single-campaing">
                    <div class="campaing-img">
                        <img src="assets/img/campaing/4.jpg" alt="">
                    </div>
                    <div class="campaing-text">
                        <div class="progress pink">
                            <div class="progress-bar">
